// =============================================================================
// src/nos-supervisor/main.cpp — nos-supervisor entry point
// =============================================================================
//
// nos-supervisor is the agent process manager for NeuralOS.
// It loads agent YAML definitions, manages AgentInstance lifecycles, and
// provides a REST API over HTTP for nos-cli and external tools.
//
// Usage:
//   nos-supervisor [--host H] [--port P] [--agents-dir DIR]
//
// Defaults:
//   --host        localhost
//   --port        8889
...
int main(int argc, char* argv[]) {
    ...
    std::cerr << "[supervisor] nos-server: " << server_url << "\n";
